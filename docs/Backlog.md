...
- [ ] **T-4** (2026-05-12) Re-probe server reachability on BackToFoyerRequested in FoyerPresenter — currently the offline banner state stays frozen from initial scope start; if server availability changes during a review session, banner won't reflect it until app restart. TODO marker already present at Assets/Scripts/Presentation/Foyer/FoyerPresenter.cs:56.
